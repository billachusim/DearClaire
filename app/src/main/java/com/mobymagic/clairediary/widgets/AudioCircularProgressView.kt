...
@Suppress("unused")
class AudioCircularProgressView : View {
    ...
    private val circlePaint = Paint(Paint.ANTI_ALIAS_FLAG).apply {
        color = ContextCompat.getColor(context, R.color.audio_progress_background)
        strokeCap = Paint.Cap.ROUND
    }
    ...
    private fun updateAnimation() {
        ...
        if (indeterminate) {
            ...
            if (currentProgress != layout_audio_download_progress) {
                currentProgress += if (currentProgress < layout_audio_download_progress) 0.01f else -0.01f
            }*/
